...
def display_temporal_tab(container, df):
    ...
    totale e per ciascun mittente utilizzando echarts.
    """
    ...
    # Le dimensioni del dataset sono: data, TOTAL, e poi ogni mittente
    dimensions = list(daily_dataset.columns)  # ["data", "TOTAL", ...]
    ...
    option_daily = {
        ...
        "dataset": [
            {
                ...
                "source": daily_dataset.values.tolist(),
            }
        ],
        ...
        "series": [
            ...
            for col in dimensions[1:]  # per ogni serie (TOTAL e mittenti)
        ],
    }
        ...
        "dataset": [
            {
                "id": "dataset_raw",
                "dimensions": dimensions,
                "source": cumulative_dataset.values.tolist(),
            }
        ],
