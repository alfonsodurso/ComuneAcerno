...
def display_temporal_tab(container, daily_counts_df, cumulative_df):
    ...
    container.plotly_chart(fig_daily, use_container_width=True, config=PLOTLY_CONFIG)
    ...
    container.plotly_chart(fig_cumulative, use_container_width=True, config=PLOTLY_CONFIG)
